...
import { fixURL, fixFilename, browserLink } from '../../util/util'
...
import { updateAnime, launchInfo, playAnime, addAnime } from '../../actions/actions'
...
class WatchInformation extends Component {
	constructor(props) {
		...
		this.fixWidths = this.fixWidths.bind(this)
	}
				...
				this.setState({
					...
					<div className="anime-information">
						...
						<table className="related-anime">
							<tbody>{this.relatedList(data.related)}</tbody>
					  </table>
					</div>
				})
			})
